      ...
      <article className='portfolio__card'>
        <div className="portfolio__content">
          ...
          <div className='portfolio__buttons'>
            ...
            <a href="" target="_blank" className='portfolio__btn'>raphaeljost.ch</a>
            <a href="" target="_blank" className='portfolio__btn'>zakudesign.ch</a>
            <a href="" target="_blank" className='portfolio__btn'>picboxi.ch</a>
            <a href="" target="_blank" className='portfolio__btn'>guttraining.ch</a>
          </div>
        </div>
      </article>
      <article className='portfolio__card'>
